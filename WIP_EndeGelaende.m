...
for i = 1:size(solx1,1)
    ...
    if ERaum2 ~= 0
        plot(ERaum2(1,:),ERaum2(2,:), 'b','LineWidth',1.0)
    end
...
for i = 1:size(solx3,1)
    ...
    %Loesung plotten
    for j = 1:size(AWerte,2)
        [t,y] = ode45(fun3,[0 20*Farbe],[double(AWerte(1,j)) double(AWerte(2,j))]);
        plot(y(:,1),y(:,2), FC)
    end
...
for i = 1:size(solx4,1)
    ...
    %Loesung plotten
    for j = 1:size(AWerte,2)
        [t,y] = ode45(fun4,[0 20*Farbe],[double(AWerte(1,j)) double(AWerte(2,j))]);
        plot(y(:,1),y(:,2), FC)
    end
...
%reele EW
function [A,B1,B2,R] = fkt_Sattel(VJ,WJ,xValue,yValue,a,b,k,d)
    ...
    a1 = [xValue+(a+k)*EW1(1)+b*d*EW1(2); yValue+(a+k)*EW1(2)-b*d*EW1(1)];
    a2 = [xValue+(a+k)*EW1(1)-b*d*EW1(2); yValue+(a+k)*EW1(2)+b*d*EW1(1)];
    a3 = [xValue-(a+k)*EW1(1)+b*d*EW1(2); yValue-(a+k)*EW1(2)-b*d*EW1(1)];
    a4 = [xValue-(a+k)*EW1(1)-b*d*EW1(2); yValue-(a+k)*EW1(2)+b*d*EW1(1)];
    a5 = [xValue+k*EW1(1)+d*EW1(2); yValue+k*EW1(2)-d*EW1(1)];
    a6 = [xValue+k*EW1(1)-d*EW1(2); yValue+k*EW1(2)+d*EW1(1)];
    a7 = [xValue-k*EW1(1)+d*EW1(2); yValue-k*EW1(2)-d*EW1(1)];
    a8 = [xValue-k*EW1(1)-d*EW1(2); yValue-k*EW1(2)+d*EW1(1)];
    A = [a1 a2 a3 a4 a5 a6 a7 a8];
    B1 = [xValue-3*EW1(1) xValue+3*EW1(1); 
          yValue-3*EW1(2) yValue+3*EW1(2)]; 
    B2 = [xValue-3*EW2(1) xValue+3*EW2(1); 
          yValue-3*EW2(2) yValue+3*EW2(2)];
end
...
function [A,B1,B2]=fkt_Knoten(VJ,WJ,xValue,yValue,a,k,d)
    ...
    if WJ(1,1)>WJ(2,2)
      a1 = [xValue+k*EW1(1)+d*EW1(2); yValue+k*EW1(2)-d*EW1(1)];
      a2 = [xValue+k*EW1(1)-d*EW1(2); yValue+k*EW1(2)+d*EW1(1)];
      a3 = [xValue-k*EW1(1)+d*EW1(2); yValue-k*EW1(2)-d*EW1(1)];
      a4 = [xValue-k*EW1(1)-d*EW1(2); yValue-k*EW1(2)+d*EW1(1)];
      a5 = [xValue+(a+k)*EW1(1)+d*EW1(2); yValue+(a+k)*EW1(2)-d*EW1(1)];
      a6 = [xValue+(a+k)*EW1(1)-d*EW1(2); yValue+(a+k)*EW1(2)+d*EW1(1)];
      a7 = [xValue-(a+k)*EW1(1)+d*EW1(2); yValue-(a+k)*EW1(2)-d*EW1(1)];
      a8 = [xValue-(a+k)*EW1(1)-d*EW1(2); yValue-(a+k)*EW1(2)+d*EW1(1)];
    else
      a1 = [xValue+k*EW2(1)+d*EW2(2); yValue+k*EW2(2)-d*EW2(1)];
      a2 = [xValue+k*EW2(1)-d*EW2(2); yValue+k*EW2(2)+d*EW2(1)];
      a3 = [xValue-k*EW2(1)+d*EW2(2); yValue-k*EW2(2)-d*EW2(1)];
      a4 = [xValue-k*EW2(1)-d*EW2(2); yValue-k*EW2(2)+d*EW2(1)];
      a5 = [xValue+(a+k)*EW2(1)+d*EW2(2); yValue+(a+k)*EW2(2)-d*EW2(1)];
      a6 = [xValue+(a+k)*EW2(1)-d*EW2(2); yValue+(a+k)*EW2(2)+d*EW2(1)];
      a7 = [xValue-(a+k)*EW2(1)+d*EW2(2); yValue-(a+k)*EW2(2)-d*EW2(1)];
      a8 = [xValue-(a+k)*EW2(1)-d*EW2(2); yValue-(a+k)*EW2(2)+d*EW2(1)];
    end
    A = [a1 a2 a3 a4 a5 a6 a7 a8];
    B1 = [xValue-3*EW1(1) xValue+3*EW1(1); 
          yValue-3*EW1(2) yValue+3*EW1(2)]; 
    ...
    if mu == lambda
        ...
        if lambda * mu == 0
            ...
            if abs(imag(lambda)) < 0.001
                if lambda * mu < 0
                    [A, B1, B2, R] = fkt_Sattel(VJ,DJ,xWert,yWert,0,6,7,0.1);
                    Sa=1
                else
                    if lambda > 0
                        %instabil
                        [A, B1, B2] = fkt_Knoten(VJ,DJ,xWert,yWert,0.5,0.5,0.05);
                        R = 1;
                        iK=1
                    else
                        %stabil
